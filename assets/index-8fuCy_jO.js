...
function Down({ size, fill }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { xmlns: "http://www.w3.org/2000/svg", height: size, viewBox: "0 -960 960 960", width: size, fill, children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M480-360 280-560h400L480-360Z" }) });
}
function Up({ size, fill }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { xmlns: "http://www.w3.org/2000/svg", height: size, viewBox: "0 -960 960 960", width: size, fill, children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "m280-400 200-200 200 200H280Z" }) });
}
const full = "_full_mtmm3_10";
const card = "_card_mtmm3_14";
const styles$2 = {
  full,
  card
};
function Section({ title, isFull, watchList, issues, children }) {
  const [visibility, setVisibility] = reactExports.useState(false);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: `card ${styles$2.card} ${isFull ? `${styles$2.full}` : ""} `, children: [
    console.log(isFull),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { children: [
          " ",
          title && title,
          "  ",
          visibility ? /* @__PURE__ */ jsxRuntimeExports.jsx(Up, { fill: "red", size: "30px" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Down, { fill: "cyan", size: "30px" }),
          " "
        ] })
      }
    ),
...
const loadingplaceholder = "_loadingplaceholder_11hub_1";
const styles$1 = {
  loadingplaceholder
};
function X({ size, fill }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { xmlns: "http://www.w3.org/2000/svg", height: size, viewBox: "0 -960 960 960", width: size, fill, children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "m256-200-56-56 224-224-224-224 56-56 224 224 224-224 56 56-224 224 224 224-56 56-224-224-224 224Z" }) });
}
const glassdialog = "_glassdialog_umatj_1";
const styles = {
  glassdialog
};
function Dialog({ openModal, closeModal, children }) {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            onClick: closeModal,
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { fill: "lightcoral", size: "24px" })
          }
        )
      ] })
    }
...
function LoadingScreen({ color, taste }) {
  function paint() {
    if (!color) return "gray";
    const hue = color.toLowerCase();
    if ((/* @__PURE__ */ new Set(["red", "blue", "green", "purple", "pink", "yellow", "gray"])).has(hue)) return hue;
    return "gray";
  }
  function fashion() {
    if (!taste) return "solid";
    const kind = taste.toLowerCase();
    if ((/* @__PURE__ */ new Set(["dotted", "solid", "ridge", "dashed", "double", "groove", "inset", "outset"])).has(kind)) return kind;
    return "solid";
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `loader ${paint()} ${fashion()}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "loader-inner" }) });
}
function Video({ topic, src, addToWatchList }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        onClick: () => {
          setModal(true);
          addToWatchList(topic);
        },
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: topic })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Dialog, { closeModal: () => {
      setModal(false);
      setIsReady(true);
    }, openModal: modal, children: [
      !isReady && /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: styles$1.loadingplaceholder, children: [
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingScreen, { taste: "dotted", color: "blue" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "iframe",
        {
...
function Renew({ size, fill }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { xmlns: "http://www.w3.org/2000/svg", height: size, viewBox: "0 -960 960 960", width: size, fill, children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M480-160q-134 0-227-93t-93-227q0-134 93-227t227-93q69 0 132 28.5T720-690v-110h80v280H520v-80h168q-32-56-87.5-88T480-720q-100 0-170 70t-70 170q0 100 70 170t170 70q77 0 139-44t87-116h84q-28 106-114 173t-196 67Z" }) });
}
const initialState = [
  {
    full: false,
...
function App() {
  const [renew, setRenew] = reactExports.useState(false);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "saluton", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
      "Lucha contra el ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Brainrot" }),
      ". Manten registro de tu progreso. Cero anuncios ;D"
    ] }) }),
    state.map((section, section_indx) => /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { title: section.title, isFull: section.full, watchList, issues: () => dispatch({ type: "completed", indx: section_indx }), children: section.contents.map((video, video_indx) => /* @__PURE__ */ jsxRuntimeExports.jsx(Video, { topic: video.topic, src: video.src, addToWatchList }, video_indx)) }, section_indx)),
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => {
      setWatchList([]);
      setRenew(true);
    }, children: renew ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "History reseted - Refresh your browser!" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Renew, { fill: "thistle", size: "24px" }) })
  ] });
}
clientExports.createRoot(document.getElementById("root")).render(
  /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(App, {}) })
);
//# sourceMappingURL=index-8fuCy_jO.js.map
